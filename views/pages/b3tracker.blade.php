...
//const fs = require("fs");
    ...
    marker = L.marker([position.coords.latitude,position.coords.longitude])//([sesionData.lat, sesionData.long])
    circle = L.circle([position.coords.latitude, position.coords.longitude], {radius: accuracy})
